...
with col_left:
    ...
    # --- PANNEAU DE DIAGNOSTIC (Gardé pour vérification) ---
...
st.text(f"DEBUG REF: {selected_ref if selected_ref else 'NOT SET'}") # LIGNE DE DEBUG CRITIQUE
...
if selected_ref and selected_ref != 'None':
    ...
    if len(selected_data_series) > 0:
        ...
        # Liste de toutes les colonnes à afficher avec formatage
        colonnes_a_afficher = [
        ...
        for nom, valeur in colonnes_a_afficher:
            ...
            # Filtre pour n'afficher que les champs pertinents
        ...
        st.warning("Veuillez m'indiquer ce que ce message rouge affiche pour la **Référence cherchée**.")
