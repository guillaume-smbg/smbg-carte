...
# --------------------- Geocoding: Google Maps link first, then OSM ---------------------
...
def main():
    ...
    # Full viewport map (CSS forces 100vh; height param is overridden)
