...
# ============== PAGE LAYOUT: 1080p fullscreen, no scroll ==============
...
st.markdown(
    ...
    <style>
      ...
      /* Folium map container to fill remaining viewport height */
...
def build_map(df_valid: pd.DataFrame, ref_col: str | None):
    ...
    # Custom HTML/CSS pin with centered ref
...
def main():
    ...
    # Render map full height
    st_folium(m, height=1080, width=None)
